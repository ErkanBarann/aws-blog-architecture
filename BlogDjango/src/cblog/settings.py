...
DATABASES = {
    'default': {
        ...
        'NAME': 'erkan', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST': 'database-1.cnkug8q0yef1.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'aws-final-blog-page-picture-videos' # please enter your s3 bucket name
